...
val previewHexagrams = listOf(
    Hexagram(
        ...
        strokes = listOf(
            ...
            HexagramStroke(
                solidLine = true,
                text = "При выходе к активной деятельности вовне у человека, подготовившего её внутренне, точно вырывается почва из-под ног, но именно эта предварительная подготовленность делает возможным благоприятный исход. Это с достаточной ясностью выражено в образе текста:",
